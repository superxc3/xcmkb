...
## Key Remap
Use VIAL, download [here](https://get.vial.today/download/). It is auto-detected in Vial. No json file is required. The key remap part is more straight forward in VIAL through Quantum tab. 
